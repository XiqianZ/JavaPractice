...
public class SevenScaleQuestionnaireUI {
	...
	private static String titleString = "ERICA‚ current emotion" + emotionTag + "in play";
	...
	private static JRadioButton strengthN3 = createScoreButton("<html><p align=\"center\">-3 <br> ‚Æ‚Ä‚àŽã‚¢</p></html>", strengthButtonGroup);
	...
	private static JRadioButton naturenessN3 = createScoreButton("<html><p align=\"center\">-3 <br> ‚Æ‚Ä‚à•sŽ©‘R</p></html>",naturenessButtonGroup);
	...
	private static JRadioButton naturenessP3 = createScoreButton("<html><p align=\"center\">3 <br> ‚Æ‚Ä‚àŽ©‘R</p></html>",naturenessButtonGroup);
	
	private static ButtonGroup friendlinessButtonGroup = new ButtonGroup();
	private static JRadioButton friendN3 = createScoreButton("<html><p align=\"center\">-3 <br> ‚Æ‚Ä‚àŽã‚¢</p></html>",friendlinessButtonGroup);
...
//		touchPatternTag = InteractionManager_ForExperiment.getGestureTag();
		titleString = "ERICA‚É‚æ‚é�u" + emotionTag + "test emotion";
